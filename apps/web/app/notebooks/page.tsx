...
export default function NotebooksPage() {
  ...
  return (
    <div className="min-h-screen">
      <div className="mx-auto max-w-7xl px-4 py-6 tablet:py-8 desktop:py-10">
        <section className="overflow-hidden rounded-[1.75rem] border border-slate-200/90 bg-white/92 p-5 shadow-[0_18px_45px_rgba(15,23,42,0.06)] backdrop-blur-sm xs:p-6 tablet:rounded-[2rem] tablet:p-8">
          <div className="flex flex-col gap-6 tablet:gap-8 desktop:flex-row desktop:items-end desktop:justify-between">
            <div className="max-w-3xl">
              ...
              <h1 className="mt-4 text-3xl font-semibold tracking-tight text-slate-950 xs:text-4xl desktop:text-5xl">
                Notebooks
              </h1>
              <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-600 xs:text-base">
            ...
            <div className="grid gap-3 xs:grid-cols-[minmax(0,1fr)_auto] desktop:min-w-[360px]">
              ...
              <Button
                ...
                disabled={isLoading}
                className="h-auto min-h-[88px] flex-col items-start justify-end rounded-[1.5rem] px-5 py-5 text-left xs:min-h-[104px]"
              >
        ...
        {!isLoading && notebooks.length > 0 ? (
          <div className="mt-6 flex justify-end">
            <Button variant="outline" onClick={openCreateDialog} className="w-full xs:w-auto">
